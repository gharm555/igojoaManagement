...
public class homeController {
    ...
    public String home(Model model) {
        ...
        Admin admin = (Admin) session.getAttribute("authenticatedAdmin");
        List<AdminDto> adminAuthorities = adminService.getAdminAuthority(admin.getAdminId());
        session.setAttribute("adminAuthorities", adminAuthorities);
